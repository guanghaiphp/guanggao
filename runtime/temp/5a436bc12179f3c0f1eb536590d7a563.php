...
<section id="content">
    ...
    <div class="page page-fullwidth-layout">
        ...
        <form action="<?php echo url('/admin/guanggao/edit'); ?>?g_id=<?php echo $g_id; ?>" method="post" enctype="multipart/form-data">
            广告名称
            <input type="text" name="name" class="form-control" value="<?php echo $g_name; ?>"><br>
            广告类型  <br><br>
        ...
        <input type="text" name="plan_id" class="form-control " value="<?php echo $plan_id; ?>" readonly ><br><br>
            ...
            安卓广告链接 <input id="shoudong1" type="text" name="lianjie_A" class="form-control" value="<?=$g_lianjie_A?>"><br>
            ...
            苹果广告链接<input id="shoudong2" type="text" name="lianjie_I" class="form-control" value="<?=$g_lianjie_I?>"><br>
