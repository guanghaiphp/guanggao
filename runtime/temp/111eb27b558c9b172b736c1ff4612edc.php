...
<a class="btn btn-danger" href="<?php echo url('admin/plan/update'); ?>?plan_id=<?php echo $item->plan_id; ?>">
                                            ...
                                            <input type="hidden" class="url" value="<script type='text/javascript' src='http://<?php echo $_SERVER['HTTP_HOST']; ?>/public/static/planjs/<?=$item->plan_id?>.js'></script>" />
