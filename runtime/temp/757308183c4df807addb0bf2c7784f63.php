...
<section id="content">
    ...
    <div class="page page-fullwidth-layout">
        ...
        <form action="<?php echo url('/admin/guanggao/add'); ?>" method="post" enctype="multipart/form-data">
       ...
       图片<input type="radio" id="img_1" name="typ"  value="2" disabled <?php echo !empty($type) && $type==2?"checked":""; ?>> <br>
       文字<input type="radio"  id="txt_1" name="typ"  value="1" disabled <?php echo !empty($type) && $type==1?"checked":""; ?>><br><br>
            ...
            安卓广告链接 <input id="shoudong1" type="text" name="lianjie_A" class="form-control"><br>
            ...
            苹果广告链接<input id="shoudong2" type="text" name="lianjie_I" class="form-control"><br>

            <input id="shangchuan2" type="file" name="lianjie_I"  style="display: none"><br>
        广告描述
        <input type="text" name="info" class="form-control"><br><br>

            <span id="txt_a" style="display: block"> 广告计划
        <input type="text" name="plan_id" class="form-control " value="<?php echo $id; ?>" readonly><br><br>
       </span>
