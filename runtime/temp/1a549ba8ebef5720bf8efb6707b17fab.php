                                    ...
                                    <tbody>
                                        <?php if(($list)): foreach($list as $item): ?>
                                            <tr id="tr_<?php echo $item->id; ?>">
                                                ...
                                                <td>
                                                    <a class="btn btn-danger" href="javascript:;"  onclick="if(confirm('确定要删除该管理员账号吗')){ deleteData(<?php echo $item->id; ?>)}">
                                                        <i class="glyphicon glyphicon-trash icon-white"></i>
                                                        删除
                                                    </a>
                                                    <a class="btn btn-danger" href="<?php echo url('admin/administrator/read'); ?>?id=<?php echo $item->id; ?>"  onclick="">
                                                        修改密码
                                                    </a>
                                                </td>
                                            </tr>
