                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong><?php echo $data['module_name']; ?></strong> 统计</h1>
                            <!--<ul class="controls">-->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-custom" id="products-list">
                                    ...
                                    <?php foreach($list as $key =>$value):?>
                                            <!--<tr id="tr_<?=$value['userip']?>" >-->
                                                <!--<td style="overflow: hidden;"><?=$value['userip']?></td>-->
                                                ...
                                                <td style="overflow: hidden;"><?=$value['shownumber']?></td>
                                                <td style="overflow: hidden;"><?=$value['click']?></td>
