                    ...
                    <div class="col-md-12">
                        ...
                        <section class="tile">
                            ...
                            <div class="tile-header dvd dvd-btm">
                                <h1 class="custom-font"><strong>修改广告计划</strong> </h1>
                            </div>

                            <div class="tile-body">
                                <form role="form" enctype="multipart/form-data" action="<?php echo url($data['module_url']).'update'; ?>" method="post">
                                    <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input id="shoudong" type="text" value="<?php echo $p_lianjie; ?>" name="p_lianjie" class="form-control"><br>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <label>尺寸</label>
                                            <input type="text" class="form-control " style="width:220px; " value="<?php echo $data['plan_width']; ?>" name="plan_width" placeholder="宽度">
                                            <input type="text" class="form-control " style="width:220px; " value="<?php echo $data['plan_height']; ?>" name="plan_height" placeholder="高度">
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <label>开始时间</label>
                                            <input type="text" class="form-control layui-input" id="start_time" value="<?php echo $data['start_time']; ?>" name="start_time" placeholder="选择开始时间">
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <label>结束时间</label>
                                            <input type="text" class="form-control layui-input" id="end_time" value="<?php echo $data['end_time']; ?>" name="end_time" placeholder="选择结束时间">
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <label>广告条数限制</label>
                                            <input type="number" class="form-control " name="limit" value="<?php echo $data['limit']; ?>" placeholder="请输入限制条数">
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select  class="selectpicker" name="status">
                                                <option value="1" <?php echo !empty($data['status']) && $data['status']==1?'selected="selected"':'';; ?>>展示</option>
                                                <option value="2" <?php echo !empty($data['status']) && $data['status']==2?'selected="selected"':'';; ?>>隐藏</option>
                                            </select>
                                        </div>
                                    </div>
