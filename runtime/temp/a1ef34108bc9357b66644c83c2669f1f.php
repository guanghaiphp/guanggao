        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url($data['module_url']); ?>">计划统计</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-body">
                           <div class="alert alert-info" style="display:none;">显示一些提示信息</div>
                            <form action="<?php echo url('record/searchPlan'); ?>" method="get">
