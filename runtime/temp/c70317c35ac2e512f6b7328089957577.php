<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:62:"D:\phpStudy\WWW\basic/application/admin\view\Record\avder.html";i:1512741934;s:56:"D:\phpStudy\WWW\basic/application/admin\view\layout.html";i:1483410766;s:56:"D:\phpStudy\WWW\basic/application/admin\view\header.html";i:1512633342;s:54:"D:\phpStudy\WWW\basic/application/admin\view\left.html";i:1512734518;s:56:"D:\phpStudy\WWW\basic/application/admin\view\footer.html";i:1509873334;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url($data['module_url']); ?>">广告统计</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>广告</strong> 统计</h1>
                        </div>
                        <!-- /tile header -->
                        <!-- tile body -->
                        <div class="tile-body">
                           <div class="alert alert-info" style="display:none;">显示一些提示信息</div>
                            <form action="<?php echo url('record/searchAdver'); ?>" method="get">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-custom" id="products-list">
                                    ...
                                    <td style="width: 120px;display:block;white-space:nowrap; overflow:hidden; text-overflow:ellipsis;"><?=$value['g_id']?></td>
                                    <td ><?=$value['g_name']?></td>
