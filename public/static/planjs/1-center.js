...
document.writeln("</style>");
document.writeln("<style>");
document.writeln(".bottomS123D{-webkit-box-sizing:border-box;position:fixed;top:50%;left:50%;z-index:1000;padding:0 0px;overflow:hidden;width:100%}.bottomS123D a{top:0;right:0;bottom:0}.dVo39{position:absolute;right:0;top:-20px;z-index:2147483647!important;width:22px;height:20px;background:rgba(0,0,0,0.1);text-align:center;color:#fff;font-size:17px;line-height:20px;font-family:Arial}");
document.writeln("</style>");
